...
<script>
  ...
  import SlideBar from "./childeComp/SlideBar";
  import { getCategory, getCategoryDetail, getSubcategory } from "network/category";
  import Subcategory from "./childeComp/Subcategory";
  import Scroll from "components/common/BScroll/Bscroll";
  import TabControl from "components/content/tabConstrol/tabConstrol";
